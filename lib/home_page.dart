...
class HomePagee extends StatefulWidget {
  ...
  @override
  State<HomePagee> createState() => _HomePageStatee();
}

class _HomePageStatee extends State<HomePagee> {
  final TextEditingController _cityController = TextEditingController();
  final Constants _constants = Constants();
  static String apiKey = 'dc251952b5984ec7ab3161933221212';

  String location = 'Astana';
  int temperature = 0;
  int windSpeed = 0;
  int humidity = 0;
  int cloud = 0;
                    ...
                    child: Row(
                      ...
                      children: [
                        WeatherItem(
                          ...
                          unit: 'km/h',
                          imageUrl:'https://cdn-icons-png.flaticon.com/512/5532/5532989.png'
                        ),
                        WeatherItem(
                            value:humidity.toInt(),
                            unit: '%',
                            imageUrl:'https://cdn-icons-png.flaticon.com/512/4148/4148388.png'
                        ),
                        WeatherItem(
                            value:cloud.toInt(),
                            unit: '%',
                            imageUrl:'https://cdn-icons-png.flaticon.com/512/704/704845.png'
                        ),
                      ],
                    ),
                  ),
